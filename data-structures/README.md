## This directory contains tasks for assignment1.
### Task 0
...
o The first element is the addition of the first element of each argument.
o The second element is the addition of the second element of each argument.
